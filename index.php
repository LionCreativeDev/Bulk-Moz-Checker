...
<body style="background: #efecec;">
    ...
    <div class="container" style="padding: 10px 10px 10px 10px;background: #fff;">
				...
				if(links.length > 0)
				{
					for(var i = 0; i < links.length; i++){
						...
						if (links[i].replace(/^\s+|\s+$/, '').length != 0) {
							//OpenLink(links[i]);
							console.log(links[i]);
							$('.table tbody').append('<tr class="nc"><td><label class="no">'+(i+1)+'</label></td><td><label class="url">'+links[i]+'</label></td><td><label class="da"></label></td><td><label class="pa"></label></td><td><label class="mozrank"></label></td></tr>');
						}
					}
